...
import { learningMode } from './learning.js'; // [추가] 카드 갱신(renderCard)을 위해 필수
...
export const ui = {
    ...
    // [이식 완료] 수정된 showCardContextMenu 적용 (새로고침 없는 삭제 기능 포함)
